...
<aside class="w-64 bg-white dark:bg-gray-800/50 border-r border-gray-200 dark:border-gray-700 fixed left-0 top-16 h-[calc(100vh-64px)] overflow-y-auto">
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            <!-- Evaluations -->
            <a href="{{ route('projects.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors font-medium">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
